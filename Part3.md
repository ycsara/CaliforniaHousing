...
**Y = Population = $\beta_0$ + $\beta_1$(total_rooms) +
$\beta_2$(total_bedrooms) + $\beta_3$(households) +
$\beta_4$(median_house_value) + $\beta_5$(median_income) +
$\beta_6$(housing_median_age) + $\epsilon$**
...
**Y = Population = $\beta_0$ + $\beta_1$(total_rooms) +
$\beta_2$(total_bedrooms) + $\beta_3$(households) + $\epsilon$**
...
**Population = $\beta_0$ + $\beta_1$(total_bedrooms) +
$\beta_2$(households) + $\beta_3$(households/bedrooms) + $\epsilon$**
